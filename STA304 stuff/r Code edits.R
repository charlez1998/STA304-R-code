...
for (i in 1:nrow(eyedata)){
  if (eyedata$Wear[i] == "Eyeglasses" | eyedata$Wear[i] == "Contact Lenses" | eyedata$Wear[i] == "Both"){
    if (eyedata$Courseload[i] == "More than 5 courses" | eyedata$Courseload[i] == "5 courses" ){
      eyedata$CourseStatus[i] <- "Glasses-Heavy"
    }      
    else if (eyedata$Courseload[i] == "3 courses" | eyedata$Courseload[i] == "Less than 3 courses" | eyedata$Courseload[i] == "4 courses"){
...
for (i in 1:nrow(eyedata)){
  if (eyedata$CourseStatus[i] == "Glasses-Heavy"){
    if (eyedata$Sleep[i] == "7 hours" | eyedata$Sleep[i] == "More than 7 hours"){
      eyedata$SleepStatus[i] <- "Glasses-Heavy, Sleep Lots"
    }
    else if (eyedata$Sleep[i] == "5 hours" | eyedata$Sleep[i] == "4 hours" | eyedata$Sleep[i] == "Less than 4 hours" | eyedata$Sleep[i] == "6 hours" ){
